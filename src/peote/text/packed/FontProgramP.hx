...
class FontProgramP extends peote.view.Program {
	public var font : FontP;
	public var fontStyle : peote.text.GlyphStylePacked;
	...
	var _buffer : peote.view.Buffer<GlyphP>;
	public function new(font:FontP, fontStyle:peote.text.GlyphStylePacked, isMasked:Bool = false, bufferMinSize:Int = 1024, bufferGrowSize:Int = 1024, bufferAutoShrink:Bool = true) {
		_buffer = new peote.view.Buffer<GlyphP>(bufferMinSize, bufferGrowSize, bufferAutoShrink);
		super(_buffer);
	...
	public inline function createLineMask(line:LineP, from:Null<Int> = null, to:Null<Int> = null, autoAdd = true):peote.text.MaskElement {
	...
	public inline function setLineMask(maskElement:peote.text.MaskElement, line:LineP, from:Null<Int> = null, to:Null<Int> = null, autoUpdate = true):Void {
		if (from != null && to != null && from > to) {
			var tmp = to;
			to = from;
			from = tmp;
	...
	public inline function skinElemToLine(skinProgram:peote.text.skin.SkinProgram, skinElement:peote.text.skin.SkinElement, line:LineP, from:Null<Int> = null, to:Null<Int> = null, autoUpdate = true):peote.text.skin.SkinElement {
		if (from != null && to != null && from > to) {
			var tmp = to;
			to = from;
			from = tmp;
	...
	public inline function setFontStyle(fontStyle:peote.text.GlyphStylePacked):Void {
	...
	inline function getCharData(charcode:Int):{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; } {
		{
			var range = font.getRange(tab2space(charcode));
			var metric = range.getMetric(tab2space(charcode));
			if (metric == null) return null else return { fontData : range, metric : metric };
		};
	}
	inline function rightGlyphPos(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		{
			return glyph.x + (charData.metric.advance - charData.metric.left) * makeTabSize(glyph, glyph.width);
		};
	}
	inline function leftGlyphPos(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		{
			return glyph.x - (charData.metric.left) * makeTabSize(glyph, glyph.width);
		};
	}
	inline function nextGlyphOffset(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		{
			return charData.metric.advance * makeTabSize(glyph, glyph.width);
		};
	}
	inline function letterSpace(glyph:GlyphP):Float {
		return glyph.letterSpace;
	}
	inline function kerningSpaceOffset(prev_glyph:GlyphP, glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		if (prev_glyph != null) {
			{
				if (font.kerning) {
					return charData.fontData.kerning[tab2space(prev_glyph.char)][tab2space(glyph.char)] * (glyph.width + prev_glyph.width) / 2 + letterSpace(prev_glyph);
				} else return letterSpace(prev_glyph);
			};
		} else return 0.0;
	}
	public function getCharSize(charCode:Int, glyphStyle:peote.text.GlyphStylePacked):Float {
		var charData = getCharData(charCode);
		if (charData == null) return 0.0;
		{
			return (charData.metric.advance - charData.metric.left) * glyphStyle.width;
		};
	}
	inline function setPosition(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }, x:Float, y:Float) {
		setXPosition(glyph, charData, x);
		setYPosition(glyph, charData, y);
	}
	inline function setXPosition(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }, x:Float) {
		{
			glyph.x = x + charData.metric.left * glyph.width;
		};
	}
	inline function setYPosition(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }, y:Float) {
		{
			glyph.y = y + (charData.fontData.base - charData.metric.top) * glyph.height;
		};
	}
	inline function getXPosition(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		return {
			glyph.x - charData.metric.left * glyph.width;
		};
	}
	inline function getYPosition(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		return {
			glyph.y - (charData.fontData.base - charData.metric.top) * glyph.height;
		};
	}
	inline function setSize(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }) {
		{
			glyph.w = charData.metric.width * glyph.width;
			glyph.h = charData.metric.height * glyph.height;
		};
	}
	public inline function setStyle(glyph:GlyphP, glyphStyle:peote.text.GlyphStylePacked) {
		glyph.setStyle((glyphStyle != null) ? glyphStyle : fontStyle);
	}
	inline function setCharcode(glyph:GlyphP, charcode:Int, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }) {
		glyph.char = charcode;
		{ };
		{ };
		{
	...
	public inline function createGlyph(charcode:Int, x:Float, y:Float, ?glyphStyle:peote.text.GlyphStylePacked, useMetric = false):GlyphP return _createGlyph(charcode, x, y, glyphStyle, useMetric, false);
	public inline function createGlyphAtBase(charcode:Int, x:Float, y:Float, ?glyphStyle:peote.text.GlyphStylePacked):GlyphP return _createGlyph(charcode, x, y, glyphStyle, true, true);
	inline function _createGlyph(charcode:Int, x:Float, y:Float, glyphStyle:peote.text.GlyphStylePacked, useMetric:Bool, atBaseline:Bool):GlyphP {
		var charData = getCharData(charcode);
		if (charData != null) {
			var glyph = new GlyphP();
	...
	public inline function glyphAdd(glyph:GlyphP):Void _buffer.addElement(glyph);
	public inline function glyphRemove(glyph:GlyphP):Void _buffer.removeElement(glyph);
	public inline function glyphSet(glyph:GlyphP, charcode:Int, x:Float, y:Float, ?glyphStyle:peote.text.GlyphStylePacked, useMetric = false):Bool return _setGlyph(glyph, charcode, x, y, glyphStyle, useMetric, false);
	public inline function glyphSetAtBase(glyph:GlyphP, charcode:Int, x:Float, y:Float, ?glyphStyle:peote.text.GlyphStylePacked):Bool return _setGlyph(glyph, charcode, x, y, glyphStyle, true, true);
	inline function _setGlyph(glyph:GlyphP, charcode:Int, x:Float, y:Float, glyphStyle:peote.text.GlyphStylePacked, useMetric:Bool, atBaseline:Bool):Bool {
		var charData = getCharData(charcode);
		if (charData != null) {
			setStyle(glyph, glyphStyle);
			setCharcode(glyph, charcode, charData);
	...
	public inline function glyphSetStyle(glyph:GlyphP, glyphStyle:peote.text.GlyphStylePacked, useMetric = false) {
		if (useMetric) {
	...
	public inline function glyphSetPosition(glyph:GlyphP, x:Float, y:Float, useMetric = false) _glyphSetPosition(glyph, x, y, useMetric, false);
	public inline function glyphSetPositionAtBase(glyph:GlyphP, x:Float, y:Float) _glyphSetPosition(glyph, x, y, true, true);
	inline function _glyphSetPosition(glyph:GlyphP, x:Float, y:Float, useMetric:Bool, atBaseline:Bool) {
		if (useMetric) {
			if (atBaseline) {
				var charData = getCharData(glyph.char);
	...
	public inline function glyphSetXPosition(glyph:GlyphP, x:Float, useMetric = false) {
		if (useMetric) setXPosition(glyph, getCharData(glyph.char), x) else glyph.x = x;
	}
	public inline function glyphGetXPosition(glyph:GlyphP, useMetric = false):Float {
		if (useMetric) return getXPosition(glyph, getCharData(glyph.char)) else return glyph.x;
	}
	public inline function glyphSetYPosition(glyph:GlyphP, y:Float, useMetric = false) _glyphSetYPosition(glyph, y, useMetric, false);
	public inline function glyphSetYPositionAtBase(glyph:GlyphP, y:Float) _glyphSetYPosition(glyph, y, true, true);
	inline function _glyphSetYPosition(glyph:GlyphP, y:Float, useMetric:Bool, atBaseline:Bool) {
		if (useMetric) {
			if (atBaseline) {
				var charData = getCharData(glyph.char);
	...
	public inline function glyphGetYPosition(glyph:GlyphP, useMetric = false):Float return _glyphGetYPosition(glyph, useMetric, false);
	public inline function glyphGetYPositionAtBase(glyph:GlyphP):Float return _glyphGetYPosition(glyph, true, true);
	inline function _glyphGetYPosition(glyph:GlyphP, useMetric:Bool, atBaseline:Bool):Float {
		if (useMetric) {
			if (atBaseline) {
				var charData = getCharData(glyph.char);
	...
	public inline function glyphGetBaseline(glyph:GlyphP):Float {
		return _getBaseline(glyph, getCharData(glyph.char));
	}
	public inline function glyphSetChar(glyph:GlyphP, charcode:Int, useMetric:Bool = false):Bool {
		var charData = getCharData(charcode);
		if (charData != null) {
			if (useMetric) {
	...
	public inline function glyphUpdate(glyph:GlyphP):Void _buffer.updateElement(glyph);
	...
	public inline function createPageLine(chars:String, x:Float = 0.0, y:Float = 0.0, ?size:Null<Float>, ?offset:Null<Float>, ?glyphStyle:Null<peote.text.GlyphStylePacked>, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):PageLineP {
		var pageLine = new PageLineP();
		pageLineSet(pageLine, chars, x, y, size, offset, glyphStyle, defaultFontRange, addRemoveGlyphes, onUnrecognizedChar);
		return pageLine;
	}
	public inline function pageLineAdd(pageLine:PageLineP):Void {
		for (i in pageLine.visibleFrom ... pageLine.visibleTo) glyphAdd(pageLine.getGlyph(i));
	}
	public inline function pageLineRemove(pageLine:PageLineP) {
		for (i in pageLine.visibleFrom ... pageLine.visibleTo) glyphRemove(pageLine.getGlyph(i));
	}
	public function pageLineSet(pageLine:PageLineP, chars:String, x:Float, ?y:Null<Float>, size:Float, offset:Float, ?glyphStyle:Null<peote.text.GlyphStylePacked>, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void) {
		var line_max = x + size;
		if (y != null) pageLine.y = y else y = pageLine.y;
		var x_start = x;
		x += offset;
		var glyph:GlyphP;
		var prev_glyph:GlyphP = null;
		var i = 0;
		var charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; } = null;
	...
	inline function _setDefaultMetric(pageLine:PageLineP, defaultFontRange:Int, glyphStyle:Null<peote.text.GlyphStylePacked>) {
	...
	inline function _setLineMetric(pageLine:PageLineP, glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }) {
		if (glyph != null) {
			{
				var h = glyph.height;
	...
	inline function _getBaseline(glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		{
			return charData.fontData.base * glyph.height;
		};
	}
	inline function _baseLineOffset(base:Float, glyph:GlyphP, charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; }):Float {
		if (glyph != null) {
			{
				return base - charData.fontData.base * glyph.height;
			};
		} else return 0;
	}
	public function pageLineSetStyle(pageLine:PageLineP, x:Float, size:Float, offset:Float, glyphStyle:peote.text.GlyphStylePacked, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):Float {
	...
	public function pageLineSetPosition(pageLine:PageLineP, x:Float, size:Float, offset:Float, xNew:Float, yNew:Float, ?offsetNew:Null<Float>, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
	...
	public function pageLineSetXPosition(pageLine:PageLineP, x:Float, size:Float, offset:Float, xNew:Float, ?offsetNew:Null<Float>, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
	...
	public function pageLineSetYPosition(pageLine:PageLineP, x:Float, size:Float, offset:Float, yNew:Float, ?offsetNew:Null<Float>, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
	...
	public function pageLineSetPositionSize(pageLine:PageLineP, x:Float, size:Float, offset:Float, xNew:Float, yNew:Float, ?offsetNew:Null<Float>, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
	...
	public function pageLineSetSize(pageLine:PageLineP, x:Float, size:Float, offset:Float, ?offsetNew:Null<Float>, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
	...
	public function pageLineSetOffset(pageLine:PageLineP, x:Float, size:Float, offset:Float, offsetNew:Float, addRemoveGlyphes:Bool = true) {
		pageLine.updateFrom = 0;
		pageLine.updateTo = pageLine.length;
		_setLinePositionOffsetFull(pageLine, x, size, offsetNew - offset, null, addRemoveGlyphes);
	}
	inline function _setLinePositionOffsetFull(pageLine:PageLineP, x:Float, size:Float, deltaX:Null<Float>, deltaY:Null<Float>, addRemoveGlyphes:Bool) {
		var line_max = x + size;
		...
		for (i in 0 ... pageLine.length) {
			...
			if (pageLine.getGlyph(i).x + pageLine.getGlyph(i).w >= x) {
	...
	inline function _setLinePositionOffset(pageLine:PageLineP, x:Float, size:Float, deltaX:Float, from:Int, withDelta:Int, to:Int, addRemoveGlyphes:Bool) {
		var line_max = x + size;
		var visibleFrom = pageLine.visibleFrom;
		var visibleTo = pageLine.visibleTo;
		for (i in from ... to) {
	...
	public function pageLineSetChar(pageLine:PageLineP, x:Float, size:Float, offset:Float, charcode:Int, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	public function pageLineSetChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, chars:String, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	public function pageLineInsertChar(pageLine:PageLineP, x:Float, size:Float, offset:Float, charcode:Int, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
		var charData = getCharData(charcode);
		if (charData != null) {
			var prev_glyph:GlyphP = null;
			var line_x = x;
	...
	public function pageLineInsertChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, chars:String, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
		var prev_glyph:GlyphP = null;
		var line_x = x;
		var y = pageLine.y;
		if (position > 0) {
	...
	public function pageLineAppendChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, chars:String, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	inline function _lineAppend(pageLine:PageLineP, line_x:Float, size:Float, offset:Float, chars:String, x:Float, y:Float, prev_glyph:GlyphP, glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
		var first = true;
		var glyph:GlyphP = null;
		var charData:{ var fontData : peote.text.Gl3FontData; var metric : peote.text.Gl3FontData.Metric; } = null;
		x += offset;
		var x_start = x;
		var line_max = line_x + size;
	...
	public function pageLineDeleteChar(pageLine:PageLineP, x:Float, size:Float, offset:Float, position:Int = 0, addRemoveGlyphes:Bool = true):Float {
	...
	public function pageLineDeleteChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):Float {
	...
	public function pageLineCutChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):String {
		if (to == null) to = pageLine.length;
		var cut = "";
		for (i in from ... to) {
	...
	public function pageLineGetChars(pageLine:PageLineP, from:Int = 0, ?to:Null<Int>):String {
		if (to == null) to = pageLine.length;
		var chars:String = "";
		for (i in from ... to) chars += String.fromCharCode(pageLine.getGlyph(i).char);
		return chars;
	}
	inline function _pageLineDeleteChars(pageLine:PageLineP, x:Float, size:Float, offset:Float, from:Int, to:Int, addRemoveGlyphes:Bool):Float {
	...
	inline function _pageLineDeleteCharsOffset(pageLine:PageLineP, x:Float, size:Float, offset:Float, from:Int, to:Int, addRemoveGlyphes:Bool):Float {
	...
	public function pageLineUpdate(pageLine:PageLineP, ?from:Null<Int>, ?to:Null<Int>) {
	...
	public function pageLineGetPositionAtChar(pageLine:PageLineP, x:Float, offset:Float, position:Int):Float {
	...
	public function pageLineGetCharAtPosition(pageLine:PageLineP, x:Float, size:Float, offset:Float, xPosition:Float, intoVisibleRange:Bool = true):Int {
	...
	inline function pageLineIsWordCharAt(pageLine:PageLineP, position:Int):Bool {
		return ~/\w/.match(String.fromCharCode(pageLine.getGlyph(position).char));
	}
	inline function pageLineIsWhitespaceCharAt(pageLine:PageLineP, position:Int):Bool {
		return ~/\s/.match(String.fromCharCode(pageLine.getGlyph(position).char));
	}
	public inline function pageLineWordLeft(pageLine:PageLineP, position:Int):Int {
	...
	public inline function pageLineWordRight(pageLine:PageLineP, position:Int):Int {
	...
	**/
	public inline function createLine(chars:String, x:Float, y:Float, ?size:Null<Float>, ?offset:Null<Float>, ?glyphStyle:Null<peote.text.GlyphStylePacked>, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):LineP {
		var line = new LineP();
	...
	**/
	public inline function lineAdd(line:LineP):Void pageLineAdd(line.pageLine);
	/**
	...
	**/
	public inline function lineRemove(line:LineP):Void pageLineRemove(line.pageLine);
	/**
	...
	**/
	public inline function lineSet(line:LineP, chars:String, ?x:Null<Float>, ?y:Null<Float>, ?size:Null<Float>, ?offset:Null<Float>, ?glyphStyle:Null<peote.text.GlyphStylePacked>, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void) {
		if (x != null) line.x = x;
	...
	**/
	public inline function lineSetStyle(line:LineP, glyphStyle:peote.text.GlyphStylePacked, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):Float {
	...
	**/
	public inline function lineSetPosition(line:LineP, x:Float, y:Float, ?offset:Null<Float>, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetXPosition(line:LineP, x:Float, ?offset:Null<Float>, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetYPosition(line:LineP, y:Float, ?offset:Null<Float>, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetPositionSize(line:LineP, x:Float, y:Float, size:Float, ?offset:Null<Float>, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetSize(line:LineP, size:Float, ?offset:Null<Float>, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetOffset(line:LineP, offset:Float, addRemoveGlyphes:Bool = true) {
	...
	**/
	public inline function lineSetChar(line:LineP, charcode:Int, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	**/
	public inline function lineSetChars(line:LineP, chars:String, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	**/
	public inline function lineInsertChar(line:LineP, charcode:Int, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	**/
	public inline function lineInsertChars(line:LineP, chars:String, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	**/
	public inline function lineAppendChars(line:LineP, chars:String, ?glyphStyle:peote.text.GlyphStylePacked, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int) -> Void):Float {
	...
	**/
	public inline function lineDeleteChar(line:LineP, position:Int = 0, addRemoveGlyphes:Bool = true):Float {
	...
	**/
	public inline function lineDeleteChars(line:LineP, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):Float {
	...
	**/
	public inline function lineCutChars(line:LineP, from:Int = 0, ?to:Null<Int>, addRemoveGlyphes:Bool = true):String {
	...
	**/
	public inline function lineGetChars(line:LineP, from:Int = 0, ?to:Null<Int>):String {
	...
	**/
	public inline function lineUpdate(line:LineP, ?from:Null<Int>, ?to:Null<Int>):Void pageLineUpdate(line.pageLine, from, to);
	/**
	...
	**/
	public inline function lineGetPositionAtChar(line:LineP, position:Int):Float {
	...
	**/
	public inline function lineGetCharAtPosition(line:LineP, xPosition:Float, intoVisibleRange:Bool = true):Int {
		return pageLineGetCharAtPosition(line.pageLine, line.x, line.size, line.offset, xPosition, intoVisibleRange);
	}
	public inline function lineWordLeft(line:LineP, position:Int):Int return pageLineWordLeft(line.pageLine, position);
	public inline function lineWordRight(line:LineP, position:Int):Int return pageLineWordRight(line.pageLine, position);
	public inline function createPage(chars:String, x:Float, y:Float, ?width:Null<Float>, ?height:Null<Float>, ?xOffset:Null<Float>, ?yOffset:Null<Float>, glyphStyle:Null<peote.text.GlyphStylePacked> = null, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int, Int) -> Void):PageP {
		var page = new PageP();
		pageSet(page, chars, x, y, width, height, xOffset, yOffset, glyphStyle, defaultFontRange, addRemoveGlyphes, onUnrecognizedChar);
		return page;
	}
	public inline function pageAdd(page:PageP) {
		for (i in page.visibleLineFrom ... page.visibleLineTo) pageLineAdd(page.getPageLine(i));
	}
	public inline function pageRemove(page:PageP) {
		for (i in page.visibleLineFrom ... page.visibleLineTo) pageLineRemove(page.getPageLine(i));
	}
	public inline function pageLineIsVisible(page:PageP, lineNumber:Int):Bool {
		return (page.visibleLineFrom <= lineNumber && lineNumber < page.visibleLineTo);
	}
	static var regLinesplit = new EReg("^(.*?)(\n|\r\n|\r)", "");
	public function pageSet(page:PageP, chars:String, ?x:Null<Float>, ?y:Null<Float>, ?width:Null<Float>, ?height:Null<Float>, ?xOffset:Null<Float>, ?yOffset:Null<Float>, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int, Int) -> Void) {
		if (x != null) page.x = x;
	...
	inline function _pageAppendChars(page:PageP, chars:String, i:Int, y:Float, visibleLineFrom:Int, visibleLineTo:Int, ?glyphStyle:peote.text.GlyphStylePacked, defaultFontRange:Null<Int>, addRemoveGlyphes:Bool, onUnrecognizedChar:(Int, Int, Int) -> Void):Float {
	...
	public function pageAppendChars(page:PageP, chars:String, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int, Int) -> Void):Float {
		chars += "\n";
		var offset:Float = 0;
		if (page.length > 0) {
	...
	public function pageSetStyle(page:PageP, glyphStyle:peote.text.GlyphStylePacked, fromLine:Int = 0, fromPosition:Int = 0, ?toLine:Null<Int>, ?toPosition:Null<Int>, addRemoveGlyphes:Bool = true):Float {
	...
	public function pageInsertChars(page:PageP, chars:String, lineNumber:Int = 0, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true, ?onUnrecognizedChar:(Int, Int, Int) -> Void):Float {
		chars += "\n";
		var offset:Float = 0.0;
		if (page.length > 0 && lineNumber < page.length) {
			if (regLinesplit.match(chars)) {
				...
				if (regLinesplit.matchedRight().length == 0) {
					...
					var restLines:Array<PageLineP> = page.spliceLines(lineNumber + 1, page.length - (lineNumber + 1));
	...
	public inline function pageTextWidthAfterExpand(page:PageP, newSize:Float) {
		if (newSize > page.textWidth) page.textWidth = newSize;
	}
	public inline function pageTextWidthAfterChange(page:PageP, oldSize:Float, newSize:Float) {
	...
	public inline function pageTextWidthAfterChangeMultiple(page:PageP, fromLine:Int, toLine:Int, oldSize:Float, newSize:Float) {
		if (newSize > page.textWidth) page.textWidth = newSize else if (oldSize >= page.textWidth && newSize < page.textWidth) {
			var pageLine:PageLineP;
			for (i in 0 ... fromLine) {
				pageLine = page.getPageLine(i);
	...
	public function pageGetChars(page:PageP, fromLine:Int = 0, ?toLine:Null<Int>, fromChar:Int = 0, ?toChar:Null<Int>):String {
	...
	public inline function pageCutChars(page:PageP, fromLine:Int = 0, ?toLine:Null<Int>, fromChar:Int = 0, ?toChar:Null<Int>, addRemoveGlyphes:Bool = true):String {
	...
	public function pageAddLinefeedAt(page:PageP, ?pageLine:PageLineP, lineNumber:Int, position:Int = 0, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true) {
	...
	public inline function pageNewLinefeed(page:PageP, ?pageLine:PageLineP, lineNumber:Int, afterLine:Bool = true, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true) {
		if (pageLine == null) pageLine = page.getPageLine(lineNumber);
	...
	public function pageRemoveLinefeed(page:PageP, ?pageLine:PageLineP, lineNumber:Int, addRemoveGlyphes:Bool = true) {
	...
	public function pageDeleteChar(page:PageP, ?pageLine:PageLineP, lineNumber:Int, position:Int, addRemoveGlyphes:Bool = true) {
		if (pageLine == null) pageLine = page.getPageLine(lineNumber);
		if (position < pageLine.length) {
	...
	public function pageDeleteChars(page:PageP, fromLine:Int, toLine:Int, fromChar:Int, toChar:Int, addRemoveGlyphes:Bool = true) {
		if (fromLine == toLine - 1) {
	...
	public function pageDeleteLine(page:PageP, lineNumber:Int, addRemoveGlyphes:Bool = true) {
		var pageLine = page.getPageLine(lineNumber);
		_pageDeleteLine(page, pageLine, pageLine.y, lineNumber, addRemoveGlyphes);
	}
	public function pageDeleteLines(page:PageP, fromLine:Int, toLine:Int, addRemoveGlyphes:Bool = true) {
	...
	inline function _pageDeleteLine(page:PageP, pageLine:PageLineP, pageLineY:Float, lineNumber:Int, addRemoveGlyphes:Bool = true) {
	...
	inline function _pageDeleteLines(page:PageP, pageLineY:Float, fromLine:Int, toLine:Int, addRemoveGlyphes:Bool = true) {
	...
	inline function _pageMoveLinesUp(page:PageP, fromLine:Int, pageLineY:Float, addRemoveGlyphes:Bool = true) {
	...
	public function pageWrapLine(page:PageP, lineNumber:Int, wordwrap:Bool = false, updatePageTextWidth:Bool = true, ?glyphStyle:peote.text.GlyphStylePacked, ?defaultFontRange:Null<Int>, addRemoveGlyphes:Bool = true):Int {
	...
	public function pageSetPosition(page:PageP, x:Float, y:Float, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
	...
	public function pageSetXPosition(page:PageP, x:Float, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
	...
	public function pageSetYPosition(page:PageP, y:Float, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
	...
	public function pageSetPositionSize(page:PageP, x:Float, y:Float, width:Float, height:Float, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
		page.height = height;
		if (page.width != width) {
	...
	public function pageSetSize(page:PageP, width:Float, height:Float, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
		page.height = height;
		if (page.width != width) {
	...
	public function pageSetOffset(page:PageP, ?xOffset:Null<Float>, ?yOffset:Null<Float>, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
	...
	public function pageSetXOffset(page:PageP, xOffset:Float, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
		for (i in 0 ... page.length) {
			var pageLine = page.getPageLine(i);
	...
	public function pageSetYOffset(page:PageP, yOffset:Float, addRemoveGlyphes:Bool = true) {
		page.updateLineFrom = 0;
		page.updateLineTo = page.length;
	...
	inline function _setPagePosSizeOffset(page:PageP, howToSet:Int, x:Null<Float>, y:Float, ?xOffset:Null<Float>, yOffset:Float, addRemoveGlyphes:Bool) {
		var visibleLineFrom = page.visibleLineFrom;
		var visibleLineTo = page.visibleLineTo;
	...
	public function pageUpdate(page:PageP, fromLine:Null<Int> = null, toLine:Null<Int> = null) {
	...
	public inline function pageGetPositionAtChar(page:PageP, pageLine:PageLineP, position:Int):Float {
		return pageLineGetPositionAtChar(pageLine, page.x, page.xOffset, position);
	}
	public inline function pageGetCharAtPosition(page:PageP, pageLine:PageLineP, xPosition:Float, intoVisibleRange:Bool = true):Int {
		return pageLineGetCharAtPosition(pageLine, page.x, page.width, page.xOffset, xPosition, intoVisibleRange);
	}
	public inline function pageGetPositionAtLine(page:PageP, lineNumber:Int):Float {
		return page.getPageLine(lineNumber).y;
	}
	public function pageGetLineAtPosition(page:PageP, yPosition:Float, intoVisibleRange:Bool = true):Int {
